...
public class StartActivity extends Activity {
    ...
    Unbinder bind;
    @BindView(R.id.writeTag) TextView mWriteTag;
    @BindView(R.id.readTag) TextView mReadTag;
    ...
    @OnClick(R.id.writeTag) void writeTag(){
    ...
    private void initFolders() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (!path.exists() && !path.mkdirs()) {
                ...
                Log.e(TAG, "Error while creating '" + Common.HOME_DIR
    ...
    private void copyStdKeysFilesIfNecessary() {
        ...
        if (!std.exists()) {
            ...
            try {
                ...
                Log.e(TAG, "Error while copying 'std.keys' from assets "
                        + "to external storage.");
            }
        }
        if (!extended.exists()) {
            ...
            try {
                ...
                Log.e(TAG, "Error while copying 'extended-std.keys' "
